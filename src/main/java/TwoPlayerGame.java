...
public class TwoPlayerGame extends JFrame implements ActionListener, MouseListener {
    //Variables
    ...
    //Second frame
    public void TwoPlayerGame2() {
        //Remove first frame
        super.dispose();

        //Make it full screen
        frame.setSize(500, 500);
        frame.setTitle("Two Mini Travelers");
